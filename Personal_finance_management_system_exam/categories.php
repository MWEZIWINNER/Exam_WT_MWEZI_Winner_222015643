...
<body bgcolor="olive">
  <header>
    <body style="background-image: url('./image/catg.jpeg'); background-size: cover; background-repeat: no-repeat;">
    ...
    <?php
     include('database_connection.php');
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $stmt = $connection->prepare("INSERT INTO categories (category_id, user_id, category_name) VALUES (?, ?, ?)");
        $stmt->bind_param("iii", $category_id, $user_id, $category_name);
