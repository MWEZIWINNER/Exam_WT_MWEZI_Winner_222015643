...
<body bgcolor="olive">
  <header>
    <body style="background-image: url('./image/goal.jpeg'); background-size: cover; background-repeat: no-repeat;">
  ...
  <section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
      ...
      <label for="goal_name">Goal_name:</label>
      <input type="text" id="goal_name" name="goal_name" required><br><br>
      
       <label for="target_amount"> Target Amount:</label>
      <input type="text" id="target_amount" name="target_amount" required><br><br>

       <label for="current_amount">Amount:</label>
      <input type="text" id="current_amount" name="current_amount" required><br><br>
    ...
    <?php
     include('database_connection.php');
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $stmt = $connection->prepare("INSERT INTO goals (goal_id,user_id,goal_name, target_amount,current_amount,target_date) VALUES (?, ?, ?, ?,?, ?)");
        $stmt->bind_param("iiiiii", $goal_id,$user_id, $goal_name, $target_amount, $current_amount,$target_date);
